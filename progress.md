...
для генератора й судді → очікувано ~0.96. **Лишилось (рантайм):** перепрогін евалу на проді для
поведінкового підтвердження + κ-калібрування судді. Park: end-to-end RAG-eval + поріг релевантності
